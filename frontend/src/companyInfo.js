...
✅ You can submit a new service request by logging into SMARTUNI, navigating to the "Ticket" section, provide  relevant details, and click "Submit Ticket."
...
✅ Go to the "Ticket" section in SMARTUNI, find your ticket, and check the status updates
...
❓ What is SMARTUNI, and how does it work?

✅ SMARTUNI is an AI-powered ticketing system that helps students and staff manage service requests efficiently. It prioritizes tickets using Machine Learning and automates assignments for faster resolutions.
❓ How does the system use Machine Learning (ML) and NLP?

✅ SMARTUNI analyzes ticket descriptions using Natural Language Processing (NLP) to determine priority levels, urgency, and category before routing them to the correct department.
❓ What are the benefits of using SMARTUNI instead of emailing requests?

✅ SMARTUNI ensures faster response times, better tracking, automated prioritization, and direct assignment to relevant department.
...
❓ How do I log in to SMARTUNI?

✅ Use your credentials (email and password) to log in via the official SMARTUNI portal.
...
✅ Take a screenshot of the error and submit a "Technical Support" request in SMARTUNI.


6. University Services & Support
❓ What kind of university services can I request through SMARTUNI?
...
✅ Yes! IT-related issues like software problems, email access, and system errors can be reported via SMARTUNI.
...
❓ Will SMARTUNI introduce a chatbot for direct ticket submission?

✅ Yes! We plan to integrate an AI chatbot for automatic ticket submission and faster responses.
❓ Can I integrate SMARTUNI with my university calendar?
...
✅ You can submit your suggestions via the “Feedback & Suggestions” section in SMARTUNI.
