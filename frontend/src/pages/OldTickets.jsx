...
function TicketHistory() {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col items-center justify-center w-full h-auto p-8 overflow-hidden bg-gray-800 bg-opacity-50 shadow-xl rounded-2xl backdrop-filter backdrop-blur-xl"
    >
        ...
        {tickets.length === 0 ? (
          ...
          <ul className="space-y-4">
            {tickets.map((ticket) => (
              ...
              >
                <h3 className="text-lg font-semibold">{ticket.ticketHeader}</h3>
